...
export function StaffMasterDetailLayout({ panel, detail }: StaffMasterDetailLayoutProps) {
  return (
    <div className="-m-6 flex min-h-screen flex-1 flex-col md:flex-row">
      <aside className="sticky top-0 z-10 flex max-h-[min(42vh,380px)] flex-col border-b border-zinc-800 bg-zinc-950/90 backdrop-blur-sm md:max-h-none md:h-screen md:w-[min(42%,28rem)] md:shrink-0 md:overflow-hidden md:border-b-0 md:border-r md:border-zinc-800">
